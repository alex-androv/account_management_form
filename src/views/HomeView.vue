<template>
  <div class="container mx-auto pt-12">
    <div class="flex items-center mb-8">
      ...
      <button @click="addAccount" class="my-4 p-4 border rounded shadow-sm"><img src="../assets/plus.svg"></button>
    </div>
    <div class="border rounded shadow-sm">
      ...
      <transition-group name="fade" tag="div">
        <div v-for="(account, index) in accounts" :key="account.id">
          <AccountItem :account="account" :index="index" @delete-account="deleteAccount" />
        </div>
      </transition-group>
    </div>
  </div>
